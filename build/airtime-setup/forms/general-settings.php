...
<form action="#" role="form" id="generalSettingsForm">
    ...
    <div id="generalFormBody">
        ...
        <p>The CORS URL can be setup during install if you are accessing your Astrax instance behind a Proxy.
	    ...
	    can safely ignore this. Please enter one URL per line. Include the entire URL such as http://example.com
            If you are reinstalling Astrax on an existing setup you can ignore this as well,
