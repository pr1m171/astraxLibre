...
function setAddShowEvents(form) {
    ...
    form.find(".show_autoplaylist_help_icon").qtip({
        content: {
            text: $.i18n._("Autoloading playlists' contents are added to shows one hour before the show airs. <a target='_blank' href='http://astrax.app/docs/playlists'>More information</a>")
        },
        hide: {
            delay: 500,
            fixed: true
