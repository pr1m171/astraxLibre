...
class Application_Form_GeneralPreferences extends Zend_Form_SubForm
{
    ...
    public function init()
    {
        ...
        $third_party_api->setLabel(_('Public Astrax API'));
        ...
        $third_party_api->setDescription(_('Enabling this feature will allow Astrax to provide schedule data
        ...
        $allowedCorsUrls->setDescription(_('Remote URLs that are allowed to access this Astrax instance in a browser. One URL per line.'));
